...
static JP2_SIGNATURES: &[Signature] = &[(
    &[
...
static CR2_SIGNATURE: &[Signature] = &[(
    &[0x49, 0x49, 0x2A, 0x00, 0x10, 0x00, 0x00, 0x00, 0x43, 0x52],
    0,
)]; // "II*\0" (little endian)
static CRW_SIGNATURE: &[Signature] = &[(
    &[
        0x49, 0x49, 0x1A, 0x00, 0x00, 0x00, 0x48, 0x45, 0x41, 0x50, 0x43, 0x43, 0x44, 0x52, 0x02,
        0x00,
    ],
    0,
)]; // "II*\0" (little endian)
