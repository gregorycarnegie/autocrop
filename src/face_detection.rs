...
pub struct Rectangle {
    #[pyo3(get, set)] pub left: i32,
    #[pyo3(get, set)] pub top: i32,
    #[pyo3(get, set)] pub right: i32,
    #[pyo3(get, set)] pub bottom: i32,
...
impl Rectangle {
    ...
    fn __mul__(&self, scale_factor: f64) -> (f64, f64, f64, f64) {
        ...
        if scale_factor > 1.0 {
            ...
            (self.left as f64, self.top as f64, self.width() as f64, self.height() as f64)
        }
    }
...
#[pyfunction]
fn determine_scale_factor(
    width: i32,
    height: i32,
    face_scale_divisor: f64
) -> PyResult<f64> {
