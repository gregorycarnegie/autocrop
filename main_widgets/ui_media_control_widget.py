...
class UiMediaControlWidget(QtWidgets.QWidget):
    def __init__(self, parent: QtWidgets.QWidget):
        ...
        self.playButton = self.create_media_button(sizePolicy, name=u"playButton",
                                                   icon_resource=GuiIcon.MULTIMEDIA_PLAY)
        self.horizontalLayout.addWidget(self.playButton)

        self.stopButton = self.create_media_button(sizePolicy, name=u"stopButton",
                                                   icon_resource=GuiIcon.MULTIMEDIA_STOP)
        self.horizontalLayout.addWidget(self.stopButton)

        self.stepbackButton = self.create_media_button(sizePolicy, name=u"stepbackButton",
                                                       icon_resource=GuiIcon.MULTIMEDIA_LEFT)
        self.horizontalLayout.addWidget(self.stepbackButton)

        self.stepfwdButton = self.create_media_button(sizePolicy, name=u"stepfwdButton",
                                                      icon_resource=GuiIcon.MULTIMEDIA_RIGHT)
        self.horizontalLayout.addWidget(self.stepfwdButton)

        self.rewindButton = self.create_media_button(sizePolicy, name=u"rewindButton",
                                                     icon_resource=GuiIcon.MULTIMEDIA_REWIND)
        self.horizontalLayout.addWidget(self.rewindButton)

        self.fastfwdButton = self.create_media_button(sizePolicy, name=u"fastfwdButton",
                                                      icon_resource=GuiIcon.MULTIMEDIA_FASTFWD)
        self.horizontalLayout.addWidget(self.fastfwdButton)

        self.goto_beginingButton = self.create_media_button(sizePolicy, name=u"goto_beginingButton",
                                                            icon_resource=GuiIcon.MULTIMEDIA_BEGINING)
        self.horizontalLayout.addWidget(self.goto_beginingButton)

        self.goto_endButton = self.create_media_button(sizePolicy, name=u"goto_endButton",
                                                       icon_resource=GuiIcon.MULTIMEDIA_END)
        self.horizontalLayout.addWidget(self.goto_endButton)

        self.startmarkerButton = self.create_media_button(sizePolicy, name=u"startmarkerButton",
                                                          icon_resource=GuiIcon.MULTIMEDIA_LEFTMARKER)
        self.horizontalLayout.addWidget(self.startmarkerButton)

        self.endmarkerButton = self.create_media_button(sizePolicy, name=u"endmarkerButton",
        ...
        self.cropButton = self.create_media_button(sizePolicy1, name=u"cropButton",
                                                   icon_resource=GuiIcon.CROP)
        self.cropButton.setDisabled(True)
        self.horizontalLayout.addWidget(self.cropButton)

        self.videocropButton = self.create_media_button(sizePolicy1, name=u"videocropButton",
                                                        icon_resource=GuiIcon.CLAPPERBOARD)
        self.horizontalLayout.addWidget(self.videocropButton)

        self.cancelButton = self.create_media_button(sizePolicy1, name=u"cancelButton",
        ...
        self.label_A = self.create_label(sizePolicy1, name=u"label_A", icon_resource=GuiIcon.MULTIMEDIA_LABEL_A)
        self.gridLayout.addWidget(self.label_A, 0, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight)

        self.selectStartMarkerButton = self.create_marker_button(sizePolicy1, u"selectStartMarkerButton")
        self.gridLayout.addWidget(self.selectStartMarkerButton, 0, 1, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight)

        self.label_B = self.create_label(sizePolicy1, name=u"label_B", icon_resource=GuiIcon.MULTIMEDIA_LABEL_B)
        self.gridLayout.addWidget(self.label_B, 1, 0, 1, 1, QtCore.Qt.AlignmentFlag.AlignRight)

        self.selectEndMarkerButton = self.create_marker_button(sizePolicy1, u"selectEndMarkerButton")
