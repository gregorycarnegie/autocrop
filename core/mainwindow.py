...
class UiMainWindow(QMainWindow):
    def __init__(self) -> None:
        ...
        self.validator = QIntValidator(100, 10_000)
        ...
        icon = QIcon()
        icon.addPixmap(QPixmap('resources/logos/logo.ico'), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.function_tabWidget = QTabWidget(parent=self.centralwidget)
        ...
        self.verticalLayout_8 = QVBoxLayout(self.photoTab)
        ...
        self.mfaceCheckBox_1, self.tiltCheckBox_1, self.exposureCheckBox_1 = self.setup_checkboxes(
            self.frame, self.horizontalLayout_8, 1)
        ...
        self.verticalLayout_15 = QVBoxLayout(self.folder_Tab)
        ...
        self.mfaceCheckBox_2, self.tiltCheckBox_2, self.exposureCheckBox_2 = self.setup_checkboxes(
            self.frame_3, self.horizontalLayout_15, 2)
        ...
        self.verticalLayout_17 = QVBoxLayout(self.mappingTab)
        ...
        self.horizontalLayout_23 = QHBoxLayout(self.frame_5)
        self.horizontalLayout_23.setObjectName('horizontalLayout_23')
        self.mfaceCheckBox_3, self.tiltCheckBox_3, self.exposureCheckBox_3 = self.setup_checkboxes(
            self.frame_5, self.horizontalLayout_23, 3)
        ...
        self.tableView = QTableView(parent=self.mappingTab)
        ...
        self.verticalLayout_22 = QVBoxLayout(self.videoTab)
        ...
        self.volumeSlider = QSlider(parent=self.frame_10)
        ...
        self.positionLabel = QLabel(parent=self.frame_10)
        self.positionLabel.setObjectName('positionLabel')
        self.horizontalLayout_32.addWidget(self.positionLabel)
        self.timelineSlider = QSlider(parent=self.frame_10)
        ...
        self.durationLabel = QLabel(parent=self.frame_10)
        self.durationLabel.setObjectName('durationLabel')
        self.horizontalLayout_32.addWidget(self.durationLabel)
        self.mfaceCheckBox_4, self.tiltCheckBox_4, self.exposureCheckBox_4 = self.setup_checkboxes(
            self.frame_10, self.horizontalLayout_32, 4, True)
        ...
        self.goto_beginingButton = self.setup_button(
            self.videoTab, 'goto_begining', 1, self.horizontalLayout_29, normal=False)
        self.goto_endButton = self.setup_button(self.videoTab, 'goto_end', 1, self.horizontalLayout_29, normal=False)
        self.startmarkerButton = self.setup_button(
            self.videoTab, 'startmarker', 1, self.horizontalLayout_29, normal=False)
        ...
        self.label_15 = QLabel(parent=self.videoTab)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_15.sizePolicy().hasHeightForWidth())
        self.label_15.setSizePolicy(sizePolicy)
        self.label_15.setMaximumSize(QSize(14, 14))
        self.label_15.setText('')
        self.label_15.setPixmap(QPixmap('resources/icons/marker_label_a.svg'))
        ...
        self.label_16 = QLabel(parent=self.videoTab)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_16.setMaximumSize(QSize(14, 14))
        self.label_16.setText('')
        self.label_16.setPixmap(QPixmap('resources/icons/marker_label_b.svg'))
        ...
        self.settings_tabWidget = QTabWidget(parent=self.centralwidget)
        self.settings_tabWidget.setTabShape(QTabWidget.TabShape.Rounded)
        ...
        self.gammaDial = setup_dial(
            self.settingsTab, 1, 2_000, 5, 100, 1_000, 1_000, True, False, False, True, 'gammaDial',
        ...
        self.label = QLabel(parent=self.settingsTab)
        ...
        self.label_2 = QLabel(parent=self.settingsTab)
        ...
        self.sensitivityDial = setup_dial(
            self.settingsTab, 0, 100, dval=50, invapp=False, invctrl=False, notchvis=True, name='sensitivityDial',
        ...
        self.label_3 = QLabel(parent=self.settingsTab)
        ...
        self.label_4 = QLabel(parent=self.settingsTab)
        ...
        self.label_5 = QLabel(parent=self.settingsTab)
        ...
        self.label_7 = QLabel(parent=self.settingsTab)
        self.label_7.setObjectName('label_7')
        self.verticalLayout_6.addWidget(self.label_7, 0, Qt.AlignmentFlag.AlignHCenter)
        ...
        icon19 = QIcon()
        icon19.addPixmap(QPixmap('resources/icons/settings.svg'), QIcon.Mode.Normal, QIcon.State.Off)
        self.settings_tabWidget.addTab(self.settingsTab, icon19, "")
        self.formatTab = QWidget()
        self.formatTab.setObjectName('formatTab')
        self.horizontalLayout_27 = QHBoxLayout(self.formatTab)
        self.horizontalLayout_27.setObjectName('horizontalLayout_27')
        self.radioButton_1 = setup_radio_button(
            self.formatTab, self.horizontalLayout_27, '_no', 1, checked=True, spacer=True)
        ...
        icon20 = QIcon()
        icon20.addPixmap(QPixmap('resources/icons/memory_card.svg'), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.topDial.valueChanged['int'].connect(self.topLCDNumber.display)
        self.bottomDial.valueChanged['int'].connect(self.bottomLCDNumber.display)
        self.leftDial.valueChanged['int'].connect(self.leftLCDNumber.display)
        self.rightDial.valueChanged['int'].connect(self.rightLCDNumber.display)
        ...
        self.videoButton.clicked.connect(
            lambda: self.video.open_video(self, self.videoLineEdit, self.playButton))
        ...
        self.crop_worker.folder_started.connect(lambda: enable_widget(self.cancelButton_1))
        ...
        self.crop_worker.mapping_started.connect(lambda: enable_widget(self.cancelButton_2))
        ...
        self.crop_worker.folder_finished.connect(
            lambda: enable_widget(self.widthLineEdit, self.heightLineEdit, self.exposureCheckBox_2,
                                  ...
                                  self.radioButton_5, self.radioButton_6, self.cropButton_2,
                                  self.exposureCheckBox_2, self.mfaceCheckBox_2, self.tiltCheckBox_2))
        self.crop_worker.folder_finished.connect(lambda: disable_widget(self.cancelButton_1))
        self.crop_worker.folder_finished.connect(lambda: show_message_box(self.destinationLineEdit_2))
        ...
        self.crop_worker.mapping_finished.connect(
            lambda: enable_widget(self.widthLineEdit, self.heightLineEdit, self.exposureCheckBox_3,
                                  ...
                                  self.radioButton_6, self.cropButton_3,
                                  self.exposureCheckBox_3, self.mfaceCheckBox_3, self.tiltCheckBox_3))
        self.crop_worker.mapping_finished.connect(lambda: disable_widget(self.cancelButton_2))
        self.crop_worker.mapping_finished.connect(lambda: show_message_box(self.destinationLineEdit_3))
        ...
        self.crop_worker.video_finished.connect(
            lambda: enable_widget(self.widthLineEdit, self.heightLineEdit, self.exposureCheckBox_4,
                                  ...
                                  self.goto_endButton, self.startmarkerButton, self.endmarkerButton,
                                  self.selectStartMarkerButton, self.selectEndMarkerButton))
        self.crop_worker.video_finished.connect(lambda: disable_widget(self.cancelButton_3))
        self.crop_worker.video_finished.connect(lambda: show_message_box(self.destinationLineEdit_4))

        self.crop_worker.folder_progress.connect(self.update_progress_1)
        self.crop_worker.mapping_progress.connect(self.update_progress_2)
        self.crop_worker.video_progress.connect(self.update_progress_3)
    ...
    def setup_checkboxes(self, parent: QWidget,
        ...
        prefixes = ('mfaceCheckBox', 'tiltCheckBox', 'exposureCheckBox')
        checkboxes = {prefix: QCheckBox(parent=parent) for prefix in prefixes}
        ...
        for prefix, checkbox in checkboxes.items():
            ...
            if prefix == 'mfaceCheckBox':
                checkbox.clicked.connect(
                    lambda: uncheck_boxes(checkboxes['exposureCheckBox'], checkboxes['tiltCheckBox']))
            else:
                checkbox.clicked.connect(lambda: uncheck_boxes(checkboxes['mfaceCheckBox']))
    ...
    def setup_line_edit(self, parent: QWidget,
        ...
        if path_type is None:
            ...
            line_edit.setMinimumSize(QSize(0, 24))
            line_edit.setMaximumSize(QSize(16_777_215, 24))
    ...
    def initialize_button(self, parent: QWidget,
        ...
        logo_dict: Dict[str, Tuple[QPixmap, str]] = {
            ...
            'folder': (QPixmap('resources/icons/folder.svg'), f'folderButton_{series}'),
            'destination': (QPixmap('resources/icons/folder.svg'), f'destinationButton_{series}'),
            'cancel': (QPixmap('resources/icons/cancel.svg'), f'cancelButton_{series}'),
            'data': (QPixmap('resources/icons/excel.svg'), 'tableButton'),
            'video': (QPixmap('resources/icons/clapperboard.svg'), 'videoButton'),
            'vcrop': (QPixmap('resources/icons/crop_video.svg'), 'videocropButton'),
            'play': (QPixmap('resources/icons/multimedia_play.svg'), 'playButton'),
            'stop': (QPixmap('resources/icons/multimedia_stop.svg'), 'stopButton'),
            'stepback': (QPixmap('resources/icons/multimedia_left.svg'), 'stepbackButton'),
            'stepfwd': (QPixmap('resources/icons/multimedia_right.svg'), 'stepfwdButton'),
            'rewind': (QPixmap('resources/icons/multimedia_rewind.svg'), 'rewindButton'),
            'fastfwd': (QPixmap('resources/icons/multimedia_fastfwd.svg'), 'fastfwdButton'),
            'goto_begining': (QPixmap('resources/icons/multimedia_begining.svg'), 'goto_beginingButton'),
            'goto_end': (QPixmap('resources/icons/multimedia_end.svg'), 'goto_endButton'),
        ...
        if normal:
            ...
            x = y = (48, 48)
        button.setMinimumSize(QSize(*x))
        button.setMaximumSize(QSize(*y))
        button.setText('')
        icon = QIcon()
    ...
    def display_crop(self, image_widget: ImageWidget,
                     ...
                     multi: QCheckBox,
                     tilt: QCheckBox) -> None:
        job = self.create_job(exposure, multi, tilt)
        self.crop_worker.display_crop(job, line_edit, image_widget)
