...
class UiMainWindow(QtWidgets.QMainWindow):
    def __init__(self) -> None:
        ...
        self.gamma_dialArea = CustomDialWidget(
            _max=2_000, single_step=5, page_step=100, _value=1000, _label='Gamma:', parent=self.settingsTab)
        self.gamma_dialArea.setObjectName("gamma_dialArea")
        self.horizontalLayout_3.addWidget(self.gamma_dialArea)
        self.face_dialArea = CustomDialWidget(_min=0, _value=62, _label='Face %:', parent=self.settingsTab)
        self.face_dialArea.setObjectName("face_dialArea")
        self.horizontalLayout_3.addWidget(self.face_dialArea)
        self.sensitivity_dialArea = CustomDialWidget(
            _min=0, _value=50, _label='Sensitivity:', parent=self.settingsTab)
        self.sensitivity_dialArea.setObjectName("sensitivity_dialArea")
        self.horizontalLayout_3.addWidget(self.sensitivity_dialArea)
        ...
        self.widthLineEdit = NumberLineEdit(parent=self.settingsTab)
        ...
        self.heightLineEdit = NumberLineEdit(parent=self.settingsTab)
        ...
        self.top_dialArea = CustomDialWidget(_min=0, _label='Top:', parent=self.settingsTab)
        self.top_dialArea.setObjectName("top_dialArea")
        self.horizontalLayout_10.addWidget(self.top_dialArea)
        self.bottom_dialArea = CustomDialWidget(_min=0, _label='Bottom:', parent=self.settingsTab)
        self.bottom_dialArea.setObjectName("bottom_dialArea")
        self.horizontalLayout_10.addWidget(self.bottom_dialArea)
        self.left_dialArea = CustomDialWidget(_min=0, _label='Left:', parent=self.settingsTab)
        self.left_dialArea.setObjectName("left_dialArea")
        self.horizontalLayout_10.addWidget(self.left_dialArea)
        self.right_dialArea = CustomDialWidget(_min=0, _label='Right:', parent=self.settingsTab)
        self.right_dialArea.setObjectName("right_dialArea")
        self.horizontalLayout_10.addWidget(self.right_dialArea)
    ...
    def retranslateUi(self):
        ...
        self.settings_tabWidget.setTabText(
            self.settings_tabWidget.indexOf(
                self.settingsTab), _translate("MainWindow", "Settings"))
        self.settings_tabWidget.setTabText(
            self.settings_tabWidget.indexOf(
                self.formatTab), _translate("MainWindow", "Format Conversion"))
